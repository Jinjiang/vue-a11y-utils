...
> This repo is not under maintenance anymore. For most of the utils you can find similar ones in [VueUse](https://vueuse.org/functions.html).
...
[See the docs](https://jinjiang.dev/vue-a11y-utils/)
